...
const reviewedTranslations: Record<string, string> = {
  ...
  "Оценка Всемирного банка": "World Bank estimate",
  "Расчёт по ВВП WDI": "Calculated using WDI GDP",
  "Входящие личные переводы, $": "Personal remittances received, $",
  "Исходящие личные переводы, $": "Personal remittances paid, $",
  "Входящие / ВВП": "Remittances received / GDP",
  "Имеют счёт, 15+": "Have an account, age 15+",
  "Совершали или получали цифровые платежи, 15+": "Made or received digital payments, age 15+",
  "Основной телефон — смартфон, 15+": "Main phone is a smartphone, age 15+",
  "Среднегодовая инфляция 2025": "Annual average inflation, 2025",
  "Статистика приведена за указанный год; оценки и расчёты отмечены отдельно. «Нет данных» означает отсутствие значения в выбранной серии. Рейтинговые баллы — экспертная модель APS, а не статистика первоисточников.": "Statistics refer to the stated year; estimates and calculations are marked separately. ‘No data’ means a value is unavailable in the selected series. Rating scores are APS expert assessments, not statistics published by the primary sources.",
  "Для Канады и Великобритании требуется пересмотр критерия трансграничных денег с учётом исходящих переводов. Их базовые рейтинги пока предварительные.": "Canada and the UK require a review of the cross-border criterion that accounts for outgoing remittances. Their base ratings remain provisional.",
  "Личные переводы WDI включают трансферты между домохозяйствами и оплату труда определённых категорий работников. Это не все международные платежи и не объём криптопереводов. Переводы BSP через банковскую систему в профиле Филиппин — отдельный показатель.": "WDI personal remittances include household transfers and compensation of certain categories of employees. They do not represent all international payments or crypto transfers. BSP cash remittances through banks in the Philippines profile are a separate measure.",
  "Для Вьетнама используется опубликованная оценка Всемирного банка: $16,0 млрд за 2024 год. Доля 3,36% рассчитана по ВВП WDI за тот же год.": "Vietnam uses the World Bank’s published estimate of $16.0 billion for 2024. The 3.36% share is calculated using WDI GDP for the same year.",
  "Баллы критериев являются экспертными оценками, а не автоматическим пересчётом статистики. Исправление суммы Вьетнама не меняет его итог 3,19: действует регуляторный ограничитель.": "Criterion scores are expert assessments, not an automatic conversion of statistics. Correcting Vietnam’s remittance amount does not change its final score of 3.19: the regulatory cap applies.",
  "Для Мексики применяется предел 2,70 из-за ограничений операционной модели и традиционных каналов продвижения. Спрос подтверждён; ограничитель относится к возможности запуска, а не к отсутствию потребности.": "Mexico’s score is capped at 2.70 because of restrictions on the operating model and traditional promotion channels. Demand is confirmed; the cap concerns launch feasibility, not a lack of need.",
  "Ограничения запуска и продвижения": "Launch and promotion restrictions",
  "Опубликованная оценка Всемирного банка: $16,0 млрд входящих переводов за 2024 год. Расчётная доля ВВП — 3,36%. Это отдельная оценочная серия, а не наблюдение WDI.": "The World Bank’s published estimate is $16.0 billion of incoming remittances in 2024. The calculated share of GDP is 3.36%. This is a separate estimated series, not a WDI observation.",
  "В 2025 году входящие переводы составили $0,83 млрд, исходящие — $15,11 млрд. Для диаспор важен исходящий поток. Прежний экспертный балл требует пересмотра по единой рубрике для отправляющих и принимающих рынков; низкий входящий поток сам по себе не означает слабый спрос.": "In 2025, incoming remittances were $0.83 billion and outgoing remittances were $15.11 billion. Outgoing flows matter for diasporas. The previous expert score requires review under a consistent rubric for sending and receiving markets; low incoming flows alone do not imply weak demand.",
  "В 2025 году входящие переводы составили $5,36 млрд, исходящие — $13,17 млрд. Для диаспор важен исходящий поток. Прежний экспертный балл требует пересмотра по единой рубрике для отправляющих и принимающих рынков; объём переводов не равен незакрытому спросу на новый продукт.": "In 2025, incoming remittances were $5.36 billion and outgoing remittances were $13.17 billion. Outgoing flows matter for diasporas. The previous expert score requires review under a consistent rubric for sending and receiving markets; transfer volume does not equal unmet demand for a new product.",
  ...
  "Тест с высоким потенциалом и высоким риском": "High-Potential, High-Risk Test",
  "Вторичная возможность": "Secondary Opportunity",
  "Долгосрочная возможность для отдельных коридоров": "Longer-Term, Corridor-Specific Opportunity",
  "Обзор": "Overview",
  "Обзор и итоги": "Overview and findings",
  "Выводы": "Conclusions",
  "Сравнение": "Comparison",
  "Профили": "Profiles",
  "Профили стран": "Country profiles",
  "Профили рынков": "Market profiles",
  "Конкуренты": "Competitors",
  "Конкуренты / тарифы": "Competitors / pricing",
  "Конкуренты по рынкам": "Competitors by market",
  "Локальные и глобальные продукты собраны в одном сравнении. Выберите страну, чтобы увидеть их роль, присутствие и окно для APS.": "Local and global products are combined in one comparison. Select a country to see their role, presence and the opportunity for APS.",
  "Присутствие глобальных продуктов": "Global product presence",
  "Матрица показывает, где подтверждены аккаунт и выпуск карты. Выбор статуса открывает единое сравнение по стране.": "The matrix shows where account access and card issuance are confirmed. Select a status to open the unified country comparison.",
  "Один реестр локальных игроков, глобальных продуктов и инфраструктуры. Детальные факты и источники раскрываются в строке.": "One register of local players, global products and infrastructure. Detailed facts and sources expand within each row.",
  "Тип и присутствие": "Type and presence",
  "Позиция на рынке": "Market position",
  "Продукт и сильная сторона": "Product and core strength",
  "Глобальный продукт": "Global product",
  "Локальный игрок": "Local player",
  "Подробнее": "Details",
  "Продукт": "Product",
  "Публичные условия": "Public terms",
  "Барьеры": "Barriers",
  "Барьеры и драйверы": "Barriers and drivers",
  "Кейсы": "Cases",
  "Кейсы и уроки": "Cases and lessons",
  "КЕЙСЫ ПО РЫНКАМ": "MARKET CASES",
  "Барьеры и драйверы в реальных запусках": "Barriers and drivers in real-world launches",
  "По каждой стране собраны подтверждённые примеры того, что сработало и что ограничило результат.": "Each market includes verified examples of what worked and what limited the outcome.",
  "кейсов и примеров": "cases and examples",
  "Контекст рынка": "Market context",
  "Сработало": "Worked",
  "Ограничило результат": "Limited the outcome",
  "Каналы": "Channels",
  "Каналы продвижения": "Promotion channels",
  "КАРТА РЫНКОВ": "MARKET ATLAS",
  "ПРОФИЛИ СТРАН": "COUNTRY PROFILES",
  "РЕГУЛЯТОРНОЕ УСЛОВИЕ": "REGULATORY REQUIREMENT",
  "ОФИЦИАЛЬНЫЕ ДАННЫЕ": "OFFICIAL EVIDENCE",
  "ПОДТВЕРЖДЁННЫЕ ТАРИФЫ": "VERIFIED PRICE POINTS",
  "ИСХОДНЫЕ ДАННЫЕ": "RAW INDICATOR DATA",
  "МЕТОДОЛОГИЯ": "METHODOLOGY",
  "РЕЕСТР ИСТОЧНИКОВ": "SOURCE REGISTER",
  "сентябрь 2026": "September 2026",
  "Филиппины: Web3-маркетинг, криптоплатежи и развитие сообществ": "Philippines: Web3 marketing, crypto payments and community development",
  "Канада и кросс-рыночный анализ: лицензирование и экономика crypto-платежей": "Canada and cross-market analysis: licensing and crypto-payment economics",
  "Вьетнам: stablecoin-платежи, регулирование и Web3-маркетинг": "Vietnam: stablecoin payments, regulation and Web3 marketing",
  "Азия и кросс-рыночный анализ: stablecoin-платежи и платёжные crypto-продукты": "Asia and cross-market analysis: stablecoin payments and crypto-payment products",
  "Великобритания и Латинская Америка: переводы и международные платежи": "United Kingdom and Latin America: remittances and international payments",
  "МВФ 2025": "IMF 2025",
  "Владеют счётом": "Account ownership",
  "Цифровые платежи": "Digital payments",
  "Смартфоны": "Smartphones",
  "Рейтинг криптоадаптации": "Crypto adoption rank",
  "Каналы привлечения": "Acquisition channels",
  "ОБНОВЛЁННАЯ КАРТА КАНАЛОВ · 2026": "UPDATED CHANNEL MAP · 2026",
  "ОБНОВЛЁННАЯ КАРТА КАНАЛОВ ПРОДВИЖЕНИЯ · 2026": "UPDATED PROMOTION CHANNEL MAP · 2026",
  ...
  "Общие правила карты каналов": "Channel-map rules",
  "Дополнительная аналитика": "Additional analysis",
  "Обобщённая стратегия и количественный охват находятся ниже полной карты каналов.": "The general strategy and quantitative reach follow the complete channel map.",
  ...
  "ЛОКАЛЬНЫЕ ЛИДЕРЫ": "LOCAL LEADERS",
  "Сравнение и выводы для APS": "Comparison and implications for APS",
  "Конкурент": "Competitor",
  "Роль на рынке": "Role in the market",
  "Сильная сторона": "Core strength",
  "Окно для APS": "Opportunity for APS",
  "Что отмечают эксперты": "Expert view",
  "Финансовое суперприложение и ведущий локальный электронный кошелёк": "Financial super-app and leading local e-wallet",
  "P2P- и QR-платежи, счета, переводы, GSave, GCrypto, кредиты, инвестиции и GCash Visa Card": "P2P and QR payments, bills, transfers, GSave, GCrypto, credit, investments and the GCash Visa Card",
  "Базовая повседневная платёжная привычка и главный ориентир для локального пользовательского опыта": "The default everyday payment habit and the key benchmark for the local user experience",
  "Масштабный набор привычных сценариев: P2P и QR, счета, переводы, GSave, GCrypto, кредиты, инвестиции и Visa-карта.": "A broad set of familiar use cases: P2P and QR payments, bills, transfers, GSave, GCrypto, credit, investments and a Visa card.",
  "Сильный локальный кошелёк, но не единый глобальный долларовый счёт для всех сценариев зарубежного дохода; международные функции зависят от отдельных партнёрских маршрутов.": "A strong local wallet, but not a single global USD account for every foreign-income use case; international features depend on separate partner routes.",
  "Эксперты рассматривают GCash как стандарт локальной платёжной привычки и конечный маршрут для международного дохода, а не как продукт, который следует заменять.": "Experts see GCash as the standard local payment habit and the final destination for international income, not as a product to replace.",
  "Не заменять GCash. Дать пользователю дешёвый и понятный вывод международного или stablecoin-дохода в GCash и использовать его как конечную локальную инфраструктуру.": "Do not replace GCash. Give users a simple, low-cost way to cash international or stablecoin income into GCash and use it as the final local rail.",
  "Локальный digital bank, электронный кошелёк и крипто-суперприложение": "Local digital bank, e-wallet and crypto super-app",
  "Wallet, QR, переводы, счета, накопления, кредит, Maya Crypto, rewards, виртуальная и физическая карты": "Wallet, QR payments, transfers, bills, savings, credit, Maya Crypto, rewards, and virtual and physical cards",
  "Прямой локальный ориентир: digital bank, wallet и криптовалютные функции внутри одного суперприложения": "A direct local benchmark: a digital bank, wallet and crypto functionality within one super-app",
  "Кошелёк, QR, переводы, счета, накопления, кредит, Maya Crypto, rewards и карты собраны в одном интерфейсе.": "Wallet, QR payments, transfers, bills, savings, credit, Maya Crypto, rewards and cards are combined in one interface.",
  "Продукт оптимизирован под локальную экосистему; окно APS возникает до конвертации в PHP — в получении зарубежного дохода, хранении USD или stablecoins и семейных переводах.": "The product is optimised for the local ecosystem; the APS opportunity arises before conversion into PHP, through foreign-income receipt, USD or stablecoin storage, and family remittances.",
  "Эксперт отдельно назвал Maya важным конкурентом: продукт уже показывает востребованность суперприложения, где платежи, банковские функции, карта и crypto доступны в одном месте.": "The expert specifically identified Maya as an important competitor: it already demonstrates demand for a super-app where payments, banking, cards and crypto are available in one place.",
  "Отличаться не ещё одним кошельком или картой, а трансграничным долларовым счётом с быстрым и дешёвым выводом в Maya.": "Differentiate through a cross-border USD account with fast, low-cost cash-out into Maya, not through another wallet or card.",
  ...
  "Неочевидные точки входа на рынок": "Non-obvious market entry points",
  "Больницы - новые центры диаспор": "Hospitals as new diaspora hubs",
  "В Канаде и UK крупные медицинские центры концентрируют филиппинских, индийских, нигерийских и карибских специалистов с регулярным международным доходом и переводами семье.": "In Canada and the UK, major medical centres bring together Filipino, Indian, Nigerian and Caribbean professionals with recurring international income and family remittances.",
  "Не таргетинг по стране, а охота за районами": "Target neighbourhoods, not entire countries",
  "Mississauga, Brampton и Surrey - готовые кластеры диаспор и трансграничных денежных коридоров. Один район может быть ценнее национальной кампании.": "Mississauga, Brampton and Surrey are established clusters of diaspora communities and cross-border money corridors. A single neighbourhood may be more valuable than a nationwide campaign.",
  "Женщины - не сегмент, а стартовая площадка": "Women as a launchpad, not just a segment",
  "На Филиппинах сообщества вокруг финансовой независимости могут стать соавторами продукта, первыми пользователями и каналом доверия к нему.": "In the Philippines, communities built around financial independence can become product co-creators, early users and a channel for trust.",
  "Моряк подключает целую семью": "One seafarer brings an entire family",
  "Партнёрство с судоходной компанией или крюинговым агентством приводит сразу двух пользователей: моряка, который получает зарплату, и семью, которая получает часть дохода на Филиппинах.": "A partnership with a shipping company or crewing agency brings two users at once: the seafarer receiving a salary and the family receiving part of that income in the Philippines.",
  "Инновация вместо слова денег": "Innovation instead of money-led messaging",
  "В Индонезии платёжное кольцо или другая заметная технология способна привлечь гораздо более широкую аудиторию, чем коммуникация внутри криптосообщества.": "In Indonesia, a payment ring or another visible technology can attract a much broader audience than messaging confined to the crypto community.",
  "Один студент - вход в семейный кошелёк": "One student as a gateway to the family wallet",
  "Студент первым осваивает продукт для оплаты обучения или международных переводов, а затем подключает родителей и других родственников. Вход на рынок через студенческие сообщества (в том числе сообщества диаспор).": "A student adopts the product first for tuition payments or international transfers, then brings in parents and other relatives. Student communities, including diaspora communities, can provide a route into the market.",
  ...
  "ВЫВОДЫ ПО РЫНКУ": "MARKET-SPECIFIC FINDINGS",
  ...
  "Самый сильный продукт появляется, когда APS понимает, между какими двумя финансовыми мирами живет пользователь. OFW и их семьи на Филиппинах. Индонезия и соседние страны Азии. Международный работодатель и сотрудник в Великобритании.": "The strongest product emerges when APS understands the two financial worlds a user lives between. OFWs and their families in the Philippines. Indonesia and neighbouring Asian countries. An international employer and employee in the United Kingdom.",
  "В Азии важнее соединить платежи, QR, счета, бонусы и lifestyle-сервисы. В Великобритании и Канаде важнее валюты, переводы, планирование, автоматизация и инвестиции. Это различие прежде всего относится к местному населению; внутри диаспор приоритеты могут быть иными.": "In Asia, it is more important to connect payments, QR, accounts, rewards and lifestyle services. In the United Kingdom and Canada, currencies, transfers, planning, automation and investments matter more. This distinction primarily applies to the local population; priorities within diaspora communities may differ.",
  "В развитых странах основной потенциал — среди диаспор": "In developed countries, the main potential lies within diaspora communities",
  "У местных жителей потребность в криптовалютных решениях невысока. Она заметно острее у трудовых мигрантов, в том числе сотрудников сферы услуг и медицинского персонала, которым важно переводить часть дохода семьям за рубеж. Потребность в получении дохода и снижении налоговой нагрузки есть у создателей контента и цифровых кочевников, однако эти группы сравнительно немногочисленны и сложно достижимы.": "Local residents have little need for cryptocurrency solutions. The need is considerably stronger among labour migrants, including service workers and healthcare staff who need to send part of their income to families abroad. Content creators and digital nomads also need to receive income and reduce their tax burden, but these groups are relatively small and difficult to reach.",
  ...
  "Исследование обновлено 24.09.2026": "Study updated 24 Sep 2026",
  ...
  "Исследование рыночного потенциала криптофинансовой платформы для платежей и управления цифровыми активами с функцией выпуска крипто-связанных платежных карт": "Market potential study for a crypto-financial platform for payments and digital-asset management, including crypto-linked payment card issuance",
  ...
  "Главный спрос - трансграничные деньги и снижение налоговой нагрузки": "The main demand is cross-border money and a lower tax burden",
  "Зарубежный доход, семейные переводы и международные специалисты дают наиболее понятные сценарии. При этом использование криптовалюты для платежей часто связано со стремлением снизить налоговую нагрузку": "Foreign income, family transfers and international professionals provide the clearest scenarios. At the same time, using cryptocurrency for payments is often linked to an effort to reduce the tax burden.",
  ...
  "В отличие от UK и Канады здесь сама пользовательская боль значительно сильнее и может быть главным двигателем привлечения.": "Unlike in the UK and Canada, the underlying user pain is significantly stronger here and can become the main acquisition driver.",
  ...
  "Опыт в Forex и Crypto": "Experience in Forex and Crypto",
  "Практический опыт развития бизнеса в сферах Forex и Crypto на рынке Индонезии": "Hands-on business development experience in Forex and Crypto in Indonesia",
  "Индонезия: развитие бизнеса в Forex и Crypto": "Indonesia: business development in Forex and Crypto",
  "Эксперт по Web3-маркетингу и развитию сообществ с опытом более 10 лет. Сооснователь CryptoFemale Philippines, Country Lead в SheFi Philippines и SEA Marketing Lead в Darkex": "Web3 marketing and community-development expert with more than 10 years of experience. Co-founder of CryptoFemale Philippines, Country Lead at SheFi Philippines and SEA Marketing Lead at Darkex",
  "Web3-маркетинг, развитие сообществ и привлечение женской аудитории в криптоиндустрию": "Web3 marketing, community development and bringing women into the crypto industry",
  "Глубокое понимание филиппинского Web3-рынка, локальных сообществ и механизмов продвижения криптопродуктов среди женщин": "Deep understanding of the Philippine Web3 market, local communities and ways to promote crypto products among women",
  "Эксперт по выходу финансовых и криптовалютных продуктов на канадский рынок. Ранее работал в Unlimint, сейчас отвечает за Канаду в криптомайнинговой компании": "Expert in bringing financial and crypto products to the Canadian market. Formerly at Unlimint and now responsible for Canada at a crypto-mining company",
  "Go-to-market стратегия, лицензирование и развитие криптовалютных продуктов": "Go-to-market strategy, licensing and crypto-product development",
  "Практический опыт оценки регуляторных требований, лицензирования и возможностей выхода на канадский рынок": "Hands-on experience assessing regulatory requirements, licensing and market-entry opportunities in Canada",
  "Специалист по маркетингу и партнёрствам в Web3, участник сообщества разработчиков и практикующий CFD- и криптотрейдер": "Web3 marketing and partnerships specialist, developer-community participant and active CFD and crypto trader",
  "Web3-маркетинг, стратегические партнёрства, сообщества разработчиков и криптотрейдинг": "Web3 marketing, strategic partnerships, developer communities and crypto trading",
  "Понимание поведения локальной криптоаудитории, профессиональных сообществ и каналов продвижения Web3-продуктов во Вьетнаме": "Understanding of local crypto-audience behaviour, professional communities and channels for promoting Web3 products in Vietnam",
  "Эксперт по stablecoin-платежам и платёжным криптопродуктам. Ранее работал с Binance Pay & Card, Bitget и RedotPay": "Expert in stablecoin payments and crypto payment products. Previously worked with Binance Pay & Card, Bitget and RedotPay",
  "Stablecoin-платежи, криптокарты, платёжная инфраструктура и развитие продуктов на азиатских рынках": "Stablecoin payments, crypto cards, payment infrastructure and product development in Asian markets",
  "Региональная экспертиза и практический опыт развития крупных криптоплатёжных продуктов в Азии": "Regional expertise and hands-on experience developing major crypto payment products in Asia",
  "Сооснователь необанка": "Co-founder of a neobank",
  "Переводы и международные платежи": "Money transfers and international payments",
  "Региональная экспертиза": "Regional expertise",
  ...
  "Всемирный банк, Global Findex, МВФ, Chainalysis и регуляторы. Год хранится рядом с каждым значением.": "The World Bank, Global Findex, the IMF, Chainalysis and regulators. The observation year is shown with every value.",
  "Учитываются KAST, прямые аналоги, криптобиржи, банки, кошельки и локальные платёжные сервисы.": "The analysis covers KAST, direct analogues, crypto exchanges, banks, wallets and local payment services.",
  "Уровень подтверждения остаётся отдельной пометкой качества доказательств и не является второй оценкой рынка.": "Evidence confidence remains a separate indicator of evidence quality and is not a second market score.",
  "Итог = min(взвешенный балл, применимый ограничитель)": "Final score = min(weighted score, applicable cap)",
  "Для Вьетнама входящие переводы 2024 рассчитаны как 3,4% от опубликованного Всемирным банком ВВП 2024; производное значение отмечено в данных.": "Vietnam's 2024 inbound remittances are calculated as 3.4% of the World Bank's published 2024 GDP figure; the derived value is flagged in the data.",
  "Сравнивать нужно полную стоимость сценария: пополнение → конвертация → оплата картой или QR → вывод средств. Заявление «0%» недостаточно без учёта ограничений, обменного курса и стоимости вывода.": "Compare the full cost of the journey: funding → conversion → card or QR payment → cash-out. A headline 0% claim is insufficient without limits, exchange rates and cash-out costs.",
